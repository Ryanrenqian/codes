...
def get_arg():
    ...
    parser.add_argument("-gr",'--growth_rate',type=int,default=3,help="number of filters to add per dense block")
    parser.add_argument("-f",'--nb_filter',type=int,default=64,help="initial number of filters. -1 indicates initial number of filters will default to 2 * growth_rate")
...
if __name__=='__main__':
    ...
    logging.basicConfig(level=logging.INFO,filename=os.path.join(save_path, 'train_v1_log_' + logtime + '.txt'))
