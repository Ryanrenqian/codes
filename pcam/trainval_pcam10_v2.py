...
def get_arg():
    ...
    parser.add_argument("-s","--save_path",type=str, default='/root/workspace/output/p4m/try10/v2/', help="save path")
...
if __name__=='__main__':
    ...
    logging.basicConfig(level=logging.INFO,filename=os.path.join(save_path, 'train_v2_log_' + logtime + '.txt'))
