"""尝试用作者回复的参数, groth rate 24, nb_filter,也就是init filters 32"""
...
def get_arg():
    ...
    parser.add_argument("-f",'--nb_filter',type=int,default=32,help="initial number of filters. -1 indicates initial number of filters will default to 2 * growth_rate")
    ...
    parser.add_argument("-s","--save_path",type=str, default='/root/workspace/output/p4m/try10/v4/', help="save path")
...
if __name__=='__main__':
    ...
    logging.basicConfig(level=logging.INFO,filename=os.path.join(save_path, 'train_v4_log_' + logtime + '.txt'))
